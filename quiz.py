...
def lista_questoes():
    with open("/Users/die-g/POJETOS/Quiz-em-python/perguntas.json", encoding="utf8") as arquivo:
...
#OBS: AS VEZES O PYTHON NÃO RECONHECE O CAMINHO RELATIVO. (resolvi colocando o caminho absoluto)
def lista_jogadores():
     with open("/Users/die-g/POJETOS/Quiz-em-python/jogadores.json","r") as arquivo:
...
def armazenar_jogador(nome,acertos):
    ...
    with open("/Users/die-g/POJETOS/Quiz-em-python/jogadores.json","w") as arquivo:        
